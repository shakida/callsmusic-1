...
async def pause(_, message: Message):
    if (
        ...
        await message.reply_text("**ՏհɑƘíժɑ:**❕ Nothing is playing.")
    else:
        callsmusic.pytgcalls.pause_stream(message.chat.id)
        await message.reply_text("**ՏհɑƘíժɑ:**⏸ Paused.")
...
async def resume(_, message: Message):
    if (
        ...
        await message.reply_text("**ՏհɑƘíժɑ:**❕ Nothing is paused.")
    else:
...
async def stop(_, message: Message):
    if message.chat.id not in callsmusic.pytgcalls.active_calls:
        await message.reply_text("**ՏհɑƘíժɑ:**❕ Nothing is streaming.")
    else:
        try:
...
async def skip(_, message: Message):
    if message.chat.id not in callsmusic.pytgcalls.active_calls:
        await message.reply_text("**ՏհɑƘíժɑ:**❕ Nothing is playing to skip.")
    else:
        ...
        await message.reply_text("**ՏհɑƘíժɑ:**⏩ Skipped the current song.")
...
async def admincache(_, message: Message):
    ...
    await message.reply_text("**ՏհɑƘíժɑ:**❇ Admin cache refreshed!")
